...
class NegSTOILoss(nn.Module):
    ...
    def forward(self, est_targets: torch.Tensor,
        ...
        if targets.ndim > 2:
            ...
            est_targets = est_targets.permute(0, 2, 1)
        ...
        #unclear about codes is doing what here
        ...
        #pack N-neighbour TF bin,which is a 386ms segmentation(maybe)
...
if __name__ == '__main__':
    ...
    source1 = torch.rand(3,32000)
    source2 = torch.rand(3,32000)

    loss = Stoi(source1,source2)
